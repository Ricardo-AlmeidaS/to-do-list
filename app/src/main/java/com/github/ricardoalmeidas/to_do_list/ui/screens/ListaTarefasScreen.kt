...
// Separado da tela acima para conseguir usar o @Preview sem depender do ViewModel.
...
private fun ConfirmarExclusaoDialog(
    ...
    AlertDialog(
        ...
        text = {
            Column {
                Text("A tarefa abaixo será excluída definitivamente:")
...
private fun ListaTarefasContentPreview() {
    ListaTarefasContent(
        tarefas = listOf(
            Tarefa(id = 1, titulo = "Estudar Room", descricao = "Entity, DAO e Database"),
            Tarefa(id = 2, titulo = "Revisar Compose", descricao = "State e recomposicao", concluida = true)
        ),
        onNovaTarefa = {},
        onEditarTarefa = {},
        onCheckedChange = { _, _ -> },
...
@Preview(showBackground = true, name = "Confirmacao de exclusao")
@Composable
private fun ListaTarefasConfirmacaoExclusaoPreview() {
    val tarefas = listOf(
        Tarefa(id = 1, titulo = "Estudar Room", descricao = "Entity, DAO e Database"),
        Tarefa(id = 2, titulo = "Revisar Compose", descricao = "State e recomposicao", concluida = true)
    )
...
private fun TarefaItemPreview() {
    TarefaItem(
        tarefa = Tarefa(id = 1, titulo = "Estudar Room", descricao = "Entity, DAO e Database"),
        onCheckedChange = {},
        onEditar = {},
        onDeletar = {}
    )
...
@Preview(showBackground = true, name = "Item concluido")
@Composable
